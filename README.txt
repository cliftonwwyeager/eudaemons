...
Neural network to detect anomalies in traffic logs for Fortigate, Palo Alto, Sonicwall, Meraki and Unifi based firewalls. Elastic Security, XSIAM, Splunk, Azure Sentinel integration | v1.10.5 | Docker Build
